        ...
        <AppLayout>
            <div className=' w-[100vw] h-screen flex flex-col'>
                ...
                <div className=' flex    items-center   justify-center'>
                    <div
                        className='w-[580px] shadow-2xl rounded-lg bg-white mt-4  max-md:bg-transparent max-md:p-6 max-lg:p-8 p-10 z-[100]'>
                        ...
                        <BMForm defaultValues={{}} onSubmit={onSubmit} validationSchemaParams={loginValidationSchema}>
                            <BMInput name='email' labelText='Tên đăng nhập' placeholder='Enter username'
